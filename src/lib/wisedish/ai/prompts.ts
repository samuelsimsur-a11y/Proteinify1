 ...
 */
const WISEDISH_CULINARY_SYSTEM = `OUTPUT FORMAT: You output compact decision objects only. You do not write swap
...
═══════════════════════════════════════════════
APP COMPACT FORMAT (API-ENFORCED — wisedish_compact_result)
═══════════════════════════════════════════════
