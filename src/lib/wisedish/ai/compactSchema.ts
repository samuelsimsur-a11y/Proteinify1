...
import { TECHNIQUE_CODES } from "@/lib/wisedish/expander/swapLibrary";
...
export const wisedishCompactFullResponseFormat: OpenAI.ResponseFormatJSONSchema = {
  type: "json_schema",
  json_schema: {
...
export const wisedishCompactSingleVersionResponseFormat: OpenAI.ResponseFormatJSONSchema = {
  type: "json_schema",
  json_schema: {
    name: "wisedish_compact_single",
    strict: true,
    description:
