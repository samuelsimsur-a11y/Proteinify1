import type { Ingredient, WiseDishResponse } from "./types";
 ...
 */
export async function enrichWiseDishResponseWithUsda(
  data: WiseDishResponse,
  usdaApiKey: string
): Promise<WiseDishResponse> {
  ...
  return { ...data, versions: versions as WiseDishResponse["versions"] };
}
