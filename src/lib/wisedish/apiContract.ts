...
import type { IngredientOverride, WiseDishResponse, SliderValues, TransformationMode } from "./types";
...
export type GenerateApiRequestBody = {
   ...
   * Defaults to "wisedish" in the backend when omitted.
   */
   ...
   */
  previousResponse?: WiseDishResponse;
  /**
...
export type GenerateDisambiguationResponse = {
  ...
  dishName: string;
  classification?: WiseDishResponse["classification"];
