...
function applyTransformationModeDefaults(
  ...
  if (!mode || mode === "wisedish") return ingredients;
...
export function generateMockWiseDishResponse(
...
export function generateFullWiseDishResponse(args: {
  dish: string;
  sliders: SliderValues;
  ...
  const closeRes = generateMockWiseDishResponse({
    dish: args.dish,
  ...
  const balancedRes = generateMockWiseDishResponse({
    dish: args.dish,
    sliders: args.sliders,
  ...
  const maxRes = generateMockWiseDishResponse({
    dish: args.dish,
    sliders: args.sliders,
