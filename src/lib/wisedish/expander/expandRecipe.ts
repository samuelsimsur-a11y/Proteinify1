...
import { parseWiseDishResponseJson, type ParseResult } from "@/lib/wisedish/parseResponse";
 ...
 */
export function parseExpandAndValidateWiseDish(
  json: unknown,
  transformationMode: TransformationMode
): ParseResult {
  ...
  return parseWiseDishResponseJson(expanded);
}
...
export function mergeSingleCompactVersion(
  ...
  return parseWiseDishResponseJson(merged);
}
