...
const serverEnvSchema = z.object({
  ...
  WISEDISH_USE_MOCK: z.enum(["true", "false"]).optional(),
});
...
const publicEnvSchema = z.object({
  ...
  NEXT_PUBLIC_WISEDISH_BUILD_ID: z.string().optional(),
});
...
export function getPublicEnvForHealth() {
  ...
  return {
    ...
    values: {
      ...
      hasBuildId: Boolean(result.data.NEXT_PUBLIC_WISEDISH_BUILD_ID),
    },
  };
}
